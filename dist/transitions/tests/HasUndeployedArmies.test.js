...
test('guard checks state', function () {
  var transition = (0, _HasUndeployedArmies2.default)(matchConfig, matchExtendedState);
...
test('guard is true when player has undeployed armies', function () {
  ...
  var transition = (0, _HasUndeployedArmies2.default)(matchConfig, matchExtendedStateCopy);
  var action = _actionCreators2.default.placeNewArmies(0, 1);
  (0, _expect2.default)(transition.guard(action)).toEqual(true);
  var state = Object.assign({}, matchExtendedStateCopy, transition.reduce(action));
  (0, _expect2.default)(state).toEqual(matchExtendedStateCopy);
});