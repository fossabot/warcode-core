...
test('reduce updates state', function () {
  ...
  (0, _expect2.default)(n.territories[attackingTerritoryIndex].armies).toBe(attackingArmies - 1);
  (0, _expect2.default)(n.territories[defendingTerritoryIndex].armies).toBe(defendingArmies - 1);
});