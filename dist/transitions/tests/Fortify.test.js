...
test('reduce updates state', function () {
  ...
  var territories = matchExtendedState.territories;

  (0, _expect2.default)(n.territories[from].armies).toBe(territories[from].armies - armiesToMove);
  (0, _expect2.default)(n.territories[to].armies).toBe(territories[to].armies + armiesToMove);
});